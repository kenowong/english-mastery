...
(function () {
  ...
  /* 音素 → 拼读用短音（用于「读 / 拼读」里的逐音拼读：尽量让 TTS 读出该音，且能连成词音）。
   * 元音用含该元音的极短片段（at/et/it…），辅音用「辅音+轻元音」（puh/buh…），均为近似示范，
   * 真正标准的整词发音以「听示范 / 听整词 / 连起来拼读」读出的真实单词为准。 */
  window.PHONICS_BLEND = {
    ...
    "/h/": "huh", "/ʃ/": "sh", "/tʃ/": "ch", "/θ/": "th", "/ð/": "th", "/dʒ/": "j",
    "/ŋ/": "ng", "/ks/": "x", "/kw/": "kw", "/st/": "st", "/ŋk/": "nk",
    "/əl/": "ul", "/ʃən/": "shun", "/ʒən/": "zhun", "/juː/": "you", "/ɔːl/": "all"
  };
